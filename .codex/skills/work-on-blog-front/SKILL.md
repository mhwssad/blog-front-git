...
1. Read `README.md`, `docs/project-structure-convention.md`, and `docs/code-writing-convention.md` before structural or cross-module work.
...
3. Prefer actual repository patterns over stale prose if they conflict, then update the relevant docs when you intentionally change the convention.
...
- Put global reusable UI only in `src/components/common` or `src/components/editor`.
...
- For table pages, prefer `min-width`, `show-overflow-tooltip`, and `useTableHeight` when height management is needed.
